/* Service worker for the Ridgeway Recreation Area Field Guide.
 *
 ...
 */
const VERSION = 'v1';
const SHELL_CACHE = 'ridgeway-shell-' + VERSION;
const TILE_CACHE = 'ridgeway-tiles-v1';
const API_CACHE = 'ridgeway-api-v1';
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    await Promise.all(names
      .filter(n => n.startsWith('ridgeway-shell-') && n !== SHELL_CACHE)
